...
# Desactivar advertencias de SSL por si la UNAM tiene certificados viejos
urllib3.disable_warnings(urllib3.exceptions.InsecureRequestWarning)

# --- CONFIGURACIÓN ---
OUTPUT_DIR = "data/sin limpiar/diccionarios"
...
if __name__ == "__main__":
    ...
    for link in tomos:
        ...
        if not pdfs:
            print(f"⚠️ ALERTA: No se encontraron PDFs en el tomo {book_id}. Posible bloqueo o cambio de sitio.")
        else:
        ...
        print("-" * 50)
        time.sleep(2) # Pausa para evitar bloqueo